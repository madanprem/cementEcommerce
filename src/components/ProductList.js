...
const ProductList = ({ addToCart, selectedCategory }) => {
  const products = [
    { id: 1, name: '8mm Steel Rod', description: 'High quality steel rod', price: 100, category: 'Steel', company: 'Jindal', size: '8mm', image: '/images/tata.jpg' },
    { id: 2, name: '10mm Steel Rod', description: 'High quality steel rod', price: 120, category: 'Steel', company: 'Jindal', size: '10mm', image: '/images/tata.jpg' },
    { id: 3, name: '8mm Steel Rod', description: 'High quality steel rod', price: 100, category: 'Steel', company: 'JSW', size: '8mm', image: '/images/vizag.jpg' },
    { id: 4, name: '10mm Steel Rod', description: 'High quality steel rod', price: 120, category: 'Steel', company: 'JSW', size: '10mm', image: '/images/vizag.jpg' },
